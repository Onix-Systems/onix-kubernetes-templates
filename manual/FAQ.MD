...
* [Как отключить redirect на https](FAQ.MD#как-мне-задать-client_max_body_size)
...
## Как отключитьredirect на https
- Для этого нам нужно отредактировать [Ingress контроллере](KIND_INGRESS.MD). Просто убрать анотации:
